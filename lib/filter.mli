...
val trace0_or_below : t
val trace1_or_below : t
val trace2_or_below : t
val trace3_or_below : t
val trace4_or_below : t
val trace5_or_below : t
val trace6_or_below : t
val trace7_or_below : t
val trace8_or_below : t
val trace9_or_below : t
(** Filter that returns [true] iff level is [Level.TRACE] or below. *)

val debug0_or_below : t
val debug1_or_below : t
val debug2_or_below : t
val debug3_or_below : t
val debug4_or_below : t
val debug5_or_below : t
val debug6_or_below : t
val debug7_or_below : t
val debug8_or_below : t
val debug9_or_below : t
(** Filter that returns [true] iff level is [Level.DEBUG] or below. *)

val info0_or_below : t
val info1_or_below : t
val info2_or_below : t
val info3_or_below : t
val info4_or_below : t
val info5_or_below : t
val info6_or_below : t
val info7_or_below : t
val info8_or_below : t
val info9_or_below : t
...
val trace0_or_above : t
val trace1_or_above : t
val trace2_or_above : t
val trace3_or_above : t
val trace4_or_above : t
val trace5_or_above : t
val trace6_or_above : t
val trace7_or_above : t
val trace8_or_above : t
val trace9_or_above : t
(** Filter that returns [true] iff level is [Level.TRACE] or above. *)

val debug0_or_above : t
val debug1_or_above : t
val debug2_or_above : t
val debug3_or_above : t
val debug4_or_above : t
val debug5_or_above : t
val debug6_or_above : t
val debug7_or_above : t
val debug8_or_above : t
val debug9_or_above : t
(** Filter that returns [true] iff level is [Level.DEBUG] or above. *)

val info0_or_above : t
val info1_or_above : t
val info2_or_above : t
val info3_or_above : t
val info4_or_above : t
val info5_or_above : t
val info6_or_above : t
val info7_or_above : t
val info8_or_above : t
val info9_or_above : t
